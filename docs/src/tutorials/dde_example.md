...
```math
\begin{aligned}
dx_0 &= \frac{v_0}{1 + \beta_0\left(x_2(t-\tau)\right)^2} \left(p_0-q_0\right)x_0(t) - d_0 x_0(t)\\
dx_1 &= \frac{v_0}{1 + \beta_0\left(x_2(t-\tau)\right)^2} \left(1-p_0+q_0\right)x_0(t)\\
     &+ \frac{v_1}{1 + \beta_1\left(x_2(t-\tau)\right)^2} \left(p_1-q_1\right)x_1(t) - d_1 x_1(t)\\
dx_2 &= \frac{v_1}{1 + \beta_1\left(x_2(t-\tau)\right)^2} \left(1-p_1+q_1\right)x_1(t) - d_2 x_2(t)
\end{aligned}
```
